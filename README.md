...
- 页面可一键查询以下 14 英寸 M5 MacBook Pro 配置，并在一次 Apple 请求中展示四个 SKU 的全部香港门店库存：
  - `MDE34ZP/A`、`MDE64ZP/A`：24GB、1TB、太空黑色 / 银色。
  - `MJ3D4ZP/A`、`MJ3E4ZP/A`：32GB、1TB、太空黑色 / 银色。
...
仓库目前未附开源许可证。公开可见不表示允许复制、修改或再分发；如需复用，请先联系仓库所有者。
